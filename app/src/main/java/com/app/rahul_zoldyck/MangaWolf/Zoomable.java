...
public class Zoomable extends ImageView {
    ...
    private Zoldyck myevent;
    public void setEventListener(Zoldyck mEventListener) {
    ...
    public Zoomable(Context context) {
        super(context);
        sharedConstructing(context);
    }

    public Zoomable(Context context, AttributeSet attrs) {
        super(context, attrs);
        sharedConstructing(context);
    }
